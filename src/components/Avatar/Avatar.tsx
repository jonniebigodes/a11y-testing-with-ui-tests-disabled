...
export const Avatar: FC<AvatarProps> = ({
  ...
  if (loading && !src) {
    ...
    avatarFigure = (
      <img src={src} alt="" title="" aria-labelledby="" aria-describedby="" role="article" />
    )
  } else {
    // Nested interactive elements - button inside a link (explicit violation)
    avatarFigure = (
      <Initial size={size} id="avatar-initial" role="article">
        <a href="#" aria-hidden="true">
          <button id="avatar-initial" aria-hidden="true">
